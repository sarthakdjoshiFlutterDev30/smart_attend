...
class _AddStudentState extends State<AddStudent> {
                                                        ...
                                                        children: [
                                                            Expanded(
                                                                child: ElevatedButton.icon(
                                                                    ...
                                                                    label: (selectedUser=="student")?Text("Add Student"):Text("Add Teacher")
                                                                )
                                                            )
                                                        ]
                                                    )
    ...
    Future<void> _addStudent() async {
        if (name.text.trim().isEmpty ||
            ...
            selectedCourse == null ||
            (selectedUser == "student" && selectedSemester == null)||
            selectedUser == null) {
        ...
        try {
            ...
            await FirebaseFirestore.instance
                ...
                .set({
                   ...
                   "semester": selectedUser == "student" ? selectedSemester : "",
            ...
            ScaffoldMessenger.of(
                context
            ).showSnackBar( SnackBar(content: Text("$selectedUser Added")));
            ...
            ScaffoldMessenger.of(
                context
            ).showSnackBar( SnackBar(content: Text("Failed to add $selectedUser")));
            setState(() {
                    _isloading = true;
                });
        }
